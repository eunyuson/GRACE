...
async function getGoogleSheetsClient() {
    console.log('🚀 Sync Script Version: 4.0.0 (GALLERY PROTECTION ENABLED)');
    console.log('⚠️ SAFETY: This script ONLY writes to the "updates" collection.');
    console.log('⚠️ SAFETY: Any items with source "shortcut" in gallery will be DELETED.');
