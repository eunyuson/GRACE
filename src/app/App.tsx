...
const Home = () => {
  return (
    <>
      <nav className="fixed top-10 left-10 z-[2100] text-white pointer-events-none mix-blend-difference">
        <h1 className="font-bold text-xs tracking-[0.3em] opacity-80 font-['Inter']">GRACE SURF DAILY</h1>
